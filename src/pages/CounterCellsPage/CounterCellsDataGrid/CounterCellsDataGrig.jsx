...
const blankRows = [{id: 1, cellName: 'Neutrófilo', absoluteCount: 0, relativeCount: "0%"}, {
    ...
    id: 7, cellName: 'Total', absoluteCount: 0, relativeCount: "0%"
},];
...
export const CounterCellsDataGrid = ({
    ...
    return (<DataGrid
        rows={keys.length === 0 ? blankRows : keys?.map((key, index) => {
            return {
                id: index + 1,
